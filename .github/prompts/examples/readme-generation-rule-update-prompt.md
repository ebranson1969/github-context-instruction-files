# README Generation Rule Update Prompt Template
...
## Template: Update README Generation Rule

```markdown
## Your Question/Request
I need you to update the README Generation Rule file in the modular instruction system.
...
- **Document prompt source: .github/prompts/examples/readme-generation-rule-update-prompt.md**

Special Considerations for Rule Updates:
- This is a GENERAL RULES rule that affects documentation generation workflows
- Changes must maintain consistency with directory structure protocols
- Updates must be thoroughly documented for future reference
- Consider impact on existing README hierarchies and linking patterns

## Expected Deliverables
- Updated readme-generation-rule.md file with requested changes
